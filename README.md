# Description
This is a context map architecture design for Aero Alpes ✈ project in order to model the requirements for domain driven design and build a no monolith solution
